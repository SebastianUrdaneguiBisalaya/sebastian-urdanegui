                    ...
                    data.map((item) => {
                        return (
                            <tr class="cursor-pointer border-t-[0.5px] border-gray-500 hover:bg-dark/5 dark:hover:bg-white/20 group">
                                <td class="w-[70px] font-reddit text-dark/80 dark:text-white/80 text-sm py-2">{extractYearFromDate(item.date)}</td>
                                <td class="w-auto font-sora text-dark/80 dark:text-white/95 text-base group-hover:underline">{item.title}</td>
                                <td class="w-[70px] font-reddit text-dark/80 dark:text-white/80 text-sm text-center">
                                ...
                                <td class="w-[90px] font-reddit text-dark/80 dark:text-white/80 text-sm text-center">
